...
namespace AVStack.IdentityServer.WebApi
{
    ...
    internal static class InternalExtensions
    {
        ...
        internal static AuthorizationRequest ToAuthorizationRequest(this ValidatedAuthorizeRequest request)
        {
            ...
            authRequest.RequestObjectValues.Clone(request.RequestObjectValues);
        ...
        [DebuggerStepThrough]
        public static void Clone<TKey, TValue>(this Dictionary<TKey, TValue> to, Dictionary<TKey, TValue> from) where TValue : ICloneable
        {
            foreach (KeyValuePair<TKey, TValue> entry in from)
            {
                to.Add(entry.Key, (TValue) entry.Value.Clone());
            }
